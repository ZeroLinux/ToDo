                        ...
                        <div class="mt-2 text-gray-600 dark:text-gray-400">
                            <form v-on:submit.prevent id="myForm" class="was-validated">
                                ...
                                <fieldset class="uk-fieldset">
                                    <legend class="uk-legend">Buscar</legend>
                                    <div class="uk-margin uk-width-1-6@m">
                                        <input class="uk-input" type="text" v-model="todo.id" placeholder="To Do Number" pattern="[0-9]{1,3}" required>
                                        <button v-if="todo.id >= 1" class="uk-button uk-button-secondary" v-on:click="searchById();">Consultar</button>
                                    </div>
                                </fieldset>
                            </form>
                        </div>
                        <div class="mt-2 text-gray-600 dark:text-gray-400" v-if="todo.completed == ''">
                            <fieldset class="uk-fieldset">
                                <legend class="uk-legend">Resultados</legend>
                                <div class="uk-card uk-card-secondary uk-card-body">
                                    <h3 class="uk-card-title"># @{{todo.id}} <span class="uk-badge"> todo.completed </span></h3>
                                    <p>@{{todo.title}}</p>
                                </div>
                            </fieldset>
                        </div>
